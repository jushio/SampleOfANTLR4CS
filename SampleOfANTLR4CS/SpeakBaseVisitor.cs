...
public partial class SpeakBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ISpeakVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="SpeakParser.word"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitWord([NotNull] SpeakParser.WordContext context) { return VisitChildren(context); }
}
