...
/// <summary>
/// This class provides an empty implementation of <see cref="ISpeakListener"/>,
/// which can be extended to create a listener which only needs to handle a subset
/// of the available methods.
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("ANTLR", "4.6")]
[System.CLSCompliant(false)]
public partial class SpeakBaseListener : ISpeakListener {
	/// <summary>
	/// Enter a parse tree produced by <see cref="SpeakParser.chat"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterChat([NotNull] SpeakParser.ChatContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterName([NotNull] SpeakParser.NameContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="SpeakParser.name"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitName([NotNull] SpeakParser.NameContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="SpeakParser.word"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterWord([NotNull] SpeakParser.WordContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="SpeakParser.word"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitWord([NotNull] SpeakParser.WordContext context) { }
